...
format_top15(sBuffer[MAX_BUFFER_LENGTH + 1])
{
	...
	iLen = format( sBuffer, MAX_BUFFER_LENGTH,
                  "<head><META http-equiv=Content-Type content='text/html ;charset=UTF-8'></head><style>body{color:#ffffff;background-color:black;background-size: 1000px 600px;margin-top:5}.A{background-color:#007bff}.B{background-color:#02598c}td{font-size:14px}</style><body background=http://blendereqq.000webhostapp.com/a/a.jpg><center><image src='http://blendereqq.000webhostapp.com/a/b.png'/></br><b><font size=2>Top 15 Graczy DD2</font></b><table width=500>")
	iLen += format( sBuffer[iLen], MAX_BUFFER_LENGTH - iLen,
                  "<tr bgcolor=#0339c1><td>%s<td>%s<td>%s<td>%s<td>%s<td>%s",
	...
	copy(sBuffer[iLen],MAX_BUFFER_LENGTH - iLen,"</table></font><!--Styl wykonany przez BlendeRa | SDL-Play.pl--!> </font>")
}
...
format_rankstats(id, sBuffer[MAX_BUFFER_LENGTH + 1], iMyId = 0)
{
	...
	iLen = format( sBuffer, MAX_BUFFER_LENGTH,
                  "<head><META http-equiv=Content-Type content='text/html ;charset=UTF-8'></head><style>body{color:#ffffff;background-image: url('https://www.sdl-play.pl/uploads/monthly_2017_09/tlo_witryny1.jpg.3dbc0ec7296ae21b5d1483a71903541f.jpg');background-size: 1000px 600px;margin-top:5}.A{background-color:#0158b5}.B{background-color:#0339c1}td{font-size:14px}</style><center><b><font size=4>RANKSTATS</b></center><tr><td>&nbsp;</td><td>&nbsp;</td></tr>" )
...
format_stats(id, sBuffer[MAX_BUFFER_LENGTH + 1])
{
	...
	iLen = format( sBuffer, MAX_BUFFER_LENGTH,
                  "<head><META http-equiv=Content-Type content='text/html ;charset=UTF-8'></head><style>body{color:#FFCC99;background-color:black;margin-top:5}.A{background-color:#310000}.B{background-color:#630000}td{font-size:14px}</style><center><b><font size=4>STATSME</b></center><tr><td>&nbsp;</td><td>&nbsp;</td></tr>" )
	iLen += format( sBuffer[iLen], MAX_BUFFER_LENGTH - iLen,
